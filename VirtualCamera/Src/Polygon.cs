...
namespace VirtualCamera.Src
{
    public class Polygon
    {
        ...
        public Polygon(Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4, Color color, Texture2D texture)
        {
            Id = idCounter++;
        ...
        {
            float sharedX = perspectiveVertices[1].X;
            float sharedY = perspectiveVertices[1].Y;
            float sharedZ = perspectiveVertices[1].Z;

            float x1 = perspectiveVertices[0].X;
            float y1 = perspectiveVertices[0].Y;
            float z1 = perspectiveVertices[0].Z;

            float x2 = perspectiveVertices[2].X;
            float y2 = perspectiveVertices[2].Y;
            float z2 = perspectiveVertices[2].Z;
